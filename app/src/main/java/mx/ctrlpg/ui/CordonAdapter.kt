...
class CordonAdapter(private val myDataset: List<SucursalCordon>) :
        RecyclerView.Adapter<CordonAdapter.MyViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup,
                                        viewType: Int): CordonAdapter.MyViewHolder {
            // create a new view
        ...
        override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
            ...
            myText.setOnClickListener{
                val bundle = bundleOf("sucursalCordon" to myDataset)
